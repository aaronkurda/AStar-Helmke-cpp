/** Hartmut Helmke 22.12.06 / 13.11.2010 / 17.11.2017
adaptiert von Originalprogramm von Vincent Godin
...
template <typename T>
inline
void printScreenColorOnceVal(std::ostream& s, short, T text)
{
   s << text;
}
...
template <typename T>
inline
void printScreenColorOnceRef(std::ostream& s, short, const T& text)
{
   s << text;
}
